---
name: loom-me
description: Grill the user about specs for recurring workflows they want to delegate — one question at a time until an implementer could build without asking. Adapted from mattpocock's loop-me for Loom PM. Credit — https://github.com/mattpocock/skills/tree/main/skills/in-progress/loop-me
disable-model-invocation: true
argument-hint: "A workflow to design, or nothing to go find one"
---

Run a stateful grilling session whose only output is **workflow** specs. Use relentless, one-question-at-a-time discipline with a recommended answer attached to each — aimed at the vocabulary and goal below. Create, edit, and delete specs as the grilling resolves things.
